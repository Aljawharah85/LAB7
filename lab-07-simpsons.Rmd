...
Your answer;there are 1,314 observations. as we know evrey raw is an observations.
...
```
Answer; if smokers continue this way, they will develop many diseases that lead to death. 
...
```
Answer; smoker no  (732) :   31,4 (dead) >> (68,6) alive
smoker yes (582) :   23,8 (dead) >> (76,2) alive.
deaths from the non-smokers are also high.
